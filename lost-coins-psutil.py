...
while True:
    try:
        increment = ''.join(random.choices('0123456789ABCDEF', k=k))  # Generate a random hexadecimal value
        print(f"Iteration {iteration_counter}: Random Increment: {increment}, k={k}")  # Display the randomly chosen increment
